            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 order-1 order-xxl-0">
                <form wire:submit.prevent='addDate' class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="row g-3 px-5">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" placeholder="Date" value="{{ $calendar->date }}" disabled>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <button type="button" class="btn bg-dark text-white btn-block d-none" wire:loading.class.remove='d-none'>
                            <i class="fa fa-spinner" aria-hidden="true"></i>
                        </button>
                        <button type="submit" class="btn bg-dark text-white btn-block" wire:loading.class='d-none'>Submit</button>
                    </div>
                </form>
            </div>
        </div>
