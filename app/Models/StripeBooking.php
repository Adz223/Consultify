...
class StripeBooking extends Model
{
    use HasFactory;
    ...
    //             // dd($diff);
    //             if($diff > 1) return $this->created_at->format("h:i a d M, Y");
    ...
    //     if($this->is_consultation) return $time->format("H:i")." - ".$time->addMinutes(30)->format("H:i");
    //     return $time->format("H:i")." - ".$time->addMinutes(60)->format("H:i");
    // }
